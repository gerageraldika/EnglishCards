package com.carpediemsolution.languagecards.presenters;
...
import com.carpediemsolution.languagecards.views.MainView;

import java.util.List;

public class MainPresenter extends BasePresenter<List<Card>, MainView> {
